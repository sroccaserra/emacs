...
(ert-deftest an-empty-string-is-empty--a-non-empty-string-is-not-empty ()
  (should (equal nil (string-empty-p "hello")))
  (should (equal nil (string-empty-p " ")))
  (should (string-empty-p (copy-seq "")))
  (should (string-empty-p nil))
  (should-error (string-empty-p 1)))

(ert-deftest I-can-tell-if-a-sring-is-blank ()
  (should (string-not-empty-p "hello"))
  (should (equal nil (string-not-empty-p "")))
  (should (equal nil (string-not-empty-p nil)))
